  ...
  "node_modules/@turf/jsts/dist/jsts.min.js"(exports, module) {
    !function(t, e) {
      ...
      function e(t2, e2, n2) {
        ...
        }(t2, h() ? Reflect.construct(e2, n2 || [], u(t2).constructor) : e2.apply(t2, n2));
      }
      function n(t2, e2) {
      ...
      function a(t2, e2) {
        ...
        if (!n2) {
          if (Array.isArray(t2) || (n2 = y2(t2)) || e2) {
            n2 && (t2 = n2);
      ...
      function o() {
        return o = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(t2, e2, n2) {
          var i2 = function(t3, e3) {
            for (; !{}.hasOwnProperty.call(t3, e3) && null !== (t3 = u(t3)); ) ;
            return t3;
          }(t2, e2);
          if (i2) {
      ...
      function f(t2, e2, n2, i2) {
        var r2 = o(u(1 & i2 ? t2.prototype : t2), e2, n2);
      ...
      A.NaN = NaN, A.isNaN = function(t2) {
        ...
        var e2, n2, i2, r2, s2, a2, o2, u2, l2;
        ...
        if (r2 = 0, l2 = 0, (e2 = S(t2)) > 1) if (e2 <= C) (r2 = S(T(e2))) <= 20 ? (l2 = 0, u2 = e2 << 20 - r2 & 1048575) : (l2 = e2 % (n2 = L(2, i2 = r2 - 20)) << 32 - i2, u2 = e2 / n2 & 1048575);
        else for (i2 = e2, l2 = 0; 0 !== (i2 = S(n2 = i2 / 2)); ) r2++, l2 >>>= 1, l2 |= (1 & u2) << 31, u2 >>>= 1, n2 !== i2 && (u2 |= 524288);
        if (o2 = r2 + N, s2 = 0 === e2, e2 = t2 - e2, r2 < 52 && 0 !== e2) for (i2 = 0; ; ) {
          if ((n2 = 2 * e2) >= 1 ? (e2 = n2 - 1, s2 ? (o2--, s2 = false) : (i2 <<= 1, i2 |= 1, r2++)) : (e2 = n2, s2 ? 0 == --o2 && (r2++, s2 = false) : (i2 <<= 1, r2++)), 20 === r2) u2 |= i2, i2 = 0;
          else if (52 === r2) {
            l2 |= i2;
            break;
          }
      ...
      var st = function() {
        ...
        return s(t2, [{ key: "le", value: function(t3) {
          ...
          if (arguments[0] instanceof t2) {
            var e2, n2, i2, r2, s2 = arguments[0], a2 = null, o2 = null, u2 = null, l2 = null;
            return e2 = (i2 = this._hi / s2._hi) - (a2 = (u2 = t2.SPLIT * i2) - (a2 = u2 - i2)), l2 = a2 * (o2 = (l2 = t2.SPLIT * s2._hi) - (o2 = l2 - s2._hi)) - (r2 = i2 * s2._hi) + a2 * (n2 = s2._hi - o2) + e2 * o2 + e2 * n2, new t2(l2 = i2 + (u2 = (this._hi - r2 - l2 + this._lo - i2 * s2._lo) / s2._hi), i2 - l2 + u2);
          }
          if ("number" == typeof arguments[0]) {
            var h2 = arguments[0];
          ...
          if (1 === arguments.length) {
            ...
            var l2, h2, c2, f2, g2 = arguments[0], v2 = arguments[1], y3 = null, d2 = null, _2 = null;
            c2 = this._hi + g2, h2 = this._lo + v2, d2 = c2 - (_2 = c2 - this._hi), y3 = h2 - (f2 = h2 - this._lo);
            var p2 = (l2 = c2 + (_2 = (d2 = g2 - _2 + (this._hi - d2)) + h2)) + (_2 = (y3 = v2 - f2 + (this._lo - y3)) + (_2 + (c2 - l2))), m2 = _2 + (l2 - p2);
          ...
          var e2, n2, i2, r2, s2 = null, a2 = null, o2 = null, u2 = null;
          e2 = (i2 = 1 / this._hi) - (s2 = (o2 = t2.SPLIT * i2) - (s2 = o2 - i2)), a2 = (u2 = t2.SPLIT * this._hi) - this._hi;
          var l2 = i2 + (o2 = (1 - (r2 = i2 * this._hi) - (u2 = s2 * (a2 = u2 - a2) - r2 + s2 * (n2 = this._hi - a2) + e2 * a2 + e2 * n2) - i2 * this._lo) / this._hi);
      ...
      var lt = function() {
        ...
        return s(t2, null, [{ key: "orientationIndex", value: function(e2, n2, i2) {
          ...
          if (r2 <= 1) return r2;
          var s2 = ut.valueOf(n2.x).selfAdd(-e2.x), a2 = ut.valueOf(n2.y).selfAdd(-e2.y), o2 = ut.valueOf(i2.x).selfAdd(-n2.x), u2 = ut.valueOf(i2.y).selfAdd(-n2.y);
      ...
      var ct = function() {
        ...
        return s(t2, null, [{ key: "index", value: function(t3, e2, n2) {
          ...
          if (arguments[0] instanceof Array) {
            ...
            do {
              u2 = (u2 + 1) % n2;
            } while (e2[u2].equals2D(i2) && u2 !== r2);
            var l2 = e2[o2], h2 = e2[u2];
          ...
          if (rt(arguments[0], ht)) {
            ...
            for (var v2 = f2.getCoordinate(0), y3 = 0, d2 = 1; d2 <= g2; d2++) {
              var _2 = f2.getCoordinate(d2);
              _2.y > v2.y && (v2 = _2, y3 = d2);
            }
            var p2 = null, k2 = y3;
            do {
              (k2 -= 1) < 0 && (k2 = g2), p2 = f2.getCoordinate(k2);
            } while (p2.equals2D(v2) && k2 !== y3);
            var x3 = null, I2 = y3;
            do {
              I2 = (I2 + 1) % g2, x3 = f2.getCoordinate(I2);
            } while (x3.equals2D(v2) && I2 !== y3);
            if (p2.equals2D(v2) || x3.equals2D(v2) || p2.equals2D(x3)) return false;
            var E2 = t2.index(p2, v2, x3);
      ...
      var ft = function() {
        ...
        return s(function t2() {
          ...
          var r2 = t2.x < e2.x ? t2.x : e2.x, s2 = t2.y < e2.y ? t2.y : e2.y, a2 = t2.x > e2.x ? t2.x : e2.x, o2 = t2.y > e2.y ? t2.y : e2.y, u2 = n2.x < i2.x ? n2.x : i2.x, l2 = n2.y < i2.y ? n2.y : i2.y, h2 = n2.x > i2.x ? n2.x : i2.x, c2 = n2.y > i2.y ? n2.y : i2.y, f2 = ((r2 > u2 ? r2 : u2) + (a2 < h2 ? a2 : h2)) / 2, g2 = ((s2 > l2 ? s2 : l2) + (o2 < c2 ? o2 : c2)) / 2, v2 = t2.x - f2, y3 = t2.y - g2, d2 = e2.x - f2, _2 = e2.y - g2, p2 = n2.x - f2, m2 = n2.y - g2, k2 = i2.x - f2, x3 = i2.y - g2, I2 = y3 - _2, E2 = d2 - v2, N2 = v2 * _2 - d2 * y3, T2 = m2 - x3, S2 = k2 - p2, L2 = p2 * x3 - k2 * m2, C2 = I2 * S2 - T2 * E2, R2 = (E2 * L2 - S2 * N2) / C2, w2 = (T2 * N2 - I2 * L2) / C2;
        ...
        return s(t2, null, [{ key: "segmentToSegment", value: function(e2, n2, i2, r2) {
          ...
          if (U.intersects(e2, n2, i2, r2)) {
            ...
            if (0 === a2) s2 = true;
              ...
              var o2 = (e2.y - i2.y) * (r2.x - i2.x) - (e2.x - i2.x) * (r2.y - i2.y), u2 = ((e2.y - i2.y) * (n2.x - e2.x) - (e2.x - i2.x) * (n2.y - e2.y)) / a2, l2 = o2 / a2;
      ...
      var Ct = function() {
        ...
        return s(function t2() {
          ...
          if (1 === arguments.length) e2.sort(function(t3, e3) {
            ...
            var u2 = e2.slice(arguments[1], arguments[2]);
            u2.sort(function(e3, n3) {
              return t2[3].compare(e3, n3);
            });
            var l2 = e2.slice(0, arguments[1]).concat(u2, e2.slice(arguments[2], e2.length));
            e2.splice(0, e2.length);
            var h2, c2 = a(l2);
            try {
        ...
        return s(t2, [{ key: "getM", value: function(t3) {
          ...
          if (this._dimension = 3, this._measures = 0, this._coordinates = null, 1 === arguments.length) {
            ...
            if (Number.isInteger(arguments[2]) && arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
              ...
              var v2 = arguments[0], y3 = arguments[1], d2 = arguments[2];
              this._coordinates = new Array(v2).fill(null), this._dimension = y3, this._measures = d2;
      ...
      var se = function(t2) {
        ...
        return s(t2, [{ key: "createEmpty", value: function(t3) {
          ...
          var u2 = e2.iterator().next();
          if (e2.size() > 1) {
            if (u2 instanceof Dt) return this.createMultiPolygon(t2.toPolygonArray(e2));
            if (u2 instanceof wt) return this.createMultiLineString(t2.toLineStringArray(e2));
            if (u2 instanceof bt) return this.createMultiPoint(t2.toPointArray(e2));
        ...
        return s(function t2(e2, i2) {
          ...
          if (this.match(ge)) {
            ...
            switch (s2) {
              ...
              case "LINESTRING":
                var u2 = this.parseLineStringText_().map(e2);
      ...
      var We = function() {
        ...
        return s(t2, null, [{ key: "maxDistance", value: function(e2, n2, i2, r2, s2, a2, o2, u2) {
          var l2 = t2.distance(e2, n2, s2, a2);
          return l2 = Math.max(l2, t2.distance(e2, n2, o2, u2)), l2 = Math.max(l2, t2.distance(i2, r2, s2, a2)), l2 = Math.max(l2, t2.distance(i2, r2, o2, u2));
          ...
          var i2 = e2.getMinX(), r2 = e2.getMinY(), s2 = e2.getMaxX(), a2 = e2.getMaxY(), o2 = n2.getMinX(), u2 = n2.getMinY(), l2 = n2.getMaxX(), h2 = n2.getMaxY(), c2 = t2.maxDistance(i2, r2, i2, a2, o2, u2, o2, h2);
      ...
      var cn = function() {
        ...
        return l(i2, t2), s(i2, [{ key: "createParentBoundablesFromVerticalSlices", value: function(t3, e2) {
          ...
          if (1 === arguments.length) {
            ...
            if (4 === arguments.length) {
              var v2 = arguments[2], y3 = arguments[3], d2 = new en(arguments[0], arguments[1]), _2 = new un(this.getRoot(), d2, v2);
      ...
      var vn = function() {
        ...
        return s(function t2() {
          ...
          if (!n2.equals2D(e2[0])) throw new D("bad split edge start point at " + n2);
          var i2 = t2.get(t2.size() - 1).getCoordinates(), r2 = i2[i2.length - 1];
          if (!r2.equals2D(e2[e2.length - 1])) throw new D("bad split edge end point at " + r2);
        } }], [{ key: "constructor_", value: function() {
      ...
      var Mn = function() {
        ...
        return s(t2, [{ key: "addNextSegment", value: function(t3, e2) {
          ...
          var s2 = e2.x - t3.x, a2 = e2.y - t3.y, o2 = Math.atan2(a2, s2), u2 = n2.x - t3.x, l2 = n2.y - t3.y, h2 = Math.atan2(l2, u2);
          ...
          var r2 = e2 === $.LEFT ? 1 : -1, s2 = t3.p1.x - t3.p0.x, a2 = t3.p1.y - t3.p0.y, o2 = Math.sqrt(s2 * s2 + a2 * a2), u2 = r2 * n2 * s2 / o2, l2 = r2 * n2 * a2 / o2;
      ...
      var An = function() {
        ...
        return s(t2, [{ key: "getOffsetCurve", value: function(t3, e2) {
          ...
          for (var u2 = o2 - 2; u2 >= 0; u2--) e2.addNextSegment(a2[u2], true);
      ...
      var Fn = function(t2) {
        ...
        return s(t2, [{ key: "getY", value: function() {
          ...
          if (this.x = null, this.y = null, this.w = null, 0 === arguments.length) this.x = 0, this.y = 0, this.w = 1;
            ...
            var c2 = arguments[0], f2 = arguments[1], g2 = arguments[2], v2 = arguments[3], y3 = c2.y - f2.y, d2 = f2.x - c2.x, _2 = c2.x * f2.y - f2.x * c2.y, p2 = g2.y - v2.y, m2 = v2.x - g2.x, k2 = g2.x * v2.y - v2.x * g2.y;
        ...
        return s(t2, [{ key: "area", value: function() {
          ...
          var r2 = e2.x, s2 = e2.y, a2 = n2.x - r2, o2 = i2.x - r2, u2 = n2.y - s2, l2 = i2.y - s2, h2 = a2 * l2 - o2 * u2, c2 = t3.x - r2, f2 = t3.y - s2, g2 = (l2 * c2 - o2 * f2) / h2, v2 = (-u2 * c2 + a2 * f2) / h2;
          ...
          var i2 = ut.valueOf(t3.x).subtract(n2.x), r2 = ut.valueOf(t3.y).subtract(n2.y), s2 = ut.valueOf(e2.x).subtract(n2.x), a2 = ut.valueOf(e2.y).subtract(n2.y), o2 = ut.determinant(i2, r2, s2, a2).multiply(2), u2 = i2.sqr().add(r2.sqr()), l2 = s2.sqr().add(a2.sqr()), h2 = ut.determinant(r2, u2, a2, l2), c2 = ut.determinant(i2, u2, s2, l2), f2 = ut.valueOf(n2.x).subtract(h2.divide(o2)).doubleValue(), g2 = ut.valueOf(n2.y).add(c2.divide(o2)).doubleValue();
          return new X(f2, g2);
        } }, { key: "isAcute", value: function(t3, e2, n2) {
          return !!bn.isAcute(t3, e2, n2) && (!!bn.isAcute(e2, n2, t3) && !!bn.isAcute(n2, t3, e2));
        } }, { key: "circumcentre", value: function(e2, n2, i2) {
          var r2 = i2.x, s2 = i2.y, a2 = e2.x - r2, o2 = e2.y - s2, u2 = n2.x - r2, l2 = n2.y - s2, h2 = 2 * t2.det(a2, o2, u2, l2), c2 = t2.det(o2, a2 * a2 + o2 * o2, l2, u2 * u2 + l2 * l2), f2 = t2.det(a2, a2 * a2 + o2 * o2, u2, u2 * u2 + l2 * l2);
          ...
          var i2 = e2.x - t3.x, r2 = e2.y - t3.y, s2 = e2.getZ() - t3.getZ(), a2 = n2.x - t3.x, o2 = n2.y - t3.y, u2 = n2.getZ() - t3.getZ(), l2 = r2 * u2 - s2 * o2, h2 = s2 * a2 - i2 * u2, c2 = i2 * o2 - r2 * a2, f2 = l2 * l2 + h2 * h2 + c2 * c2, g2 = Math.sqrt(f2) / 2;
          return g2;
        } }, { key: "centroid", value: function(t3, e2, n2) {
          var i2 = (t3.x + e2.x + n2.x) / 3, r2 = (t3.y + e2.y + n2.y) / 3;
          return new X(i2, r2);
        } }, { key: "inCentre", value: function(t3, e2, n2) {
          var i2 = e2.distance(n2), r2 = t3.distance(n2), s2 = t3.distance(e2), a2 = i2 + r2 + s2, o2 = (i2 * t3.x + r2 * e2.x + s2 * n2.x) / a2, u2 = (i2 * t3.y + r2 * e2.y + s2 * n2.y) / a2;
          return new X(o2, u2);
        } }]);
      }(), Yn = function() {
        return s(function t2() {
        ...
        return s(t2, [{ key: "compareTo", value: function(e2) {
          ...
          for (var r2 = e2 ? 1 : -1, s2 = i2 ? 1 : -1, a2 = e2 ? t3.length : -1, o2 = i2 ? n2.length : -1, u2 = e2 ? 0 : t3.length - 1, l2 = i2 ? 0 : n2.length - 1; ; ) {
      ...
      var ri = function(t2) {
        ...
        return s(t2, [{ key: "checkEndPtVertexIntersections", value: function() {
          ...
          if (0 === arguments.length) for (var t3 = this._segStrings.iterator(); t3.hasNext(); ) for (var e2 = t3.next(), n2 = this._segStrings.iterator(); n2.hasNext(); ) {
            ...
            var v2 = h2.getCoordinates()[c2], y3 = h2.getCoordinates()[c2 + 1], d2 = f2.getCoordinates()[g2], _2 = f2.getCoordinates()[g2 + 1];
            if (this._li.computeIntersection(v2, y3, d2, _2), this._li.hasIntersection() && (this._li.isProper() || this.hasInteriorIntersection(this._li, v2, y3) || this.hasInteriorIntersection(this._li, d2, _2))) throw new D("found non-noded intersection at " + v2 + "-" + y3 + " and " + d2 + "-" + _2);
          }
          ...
          if (e2.equals(i2)) throw new D("found non-noded collapse at " + t2.fact.createLineString([e2, n2, i2]));
        } }], [{ key: "constructor_", value: function() {
    ...
    !function(t, e) {
      ...
      t.orient2d = function(t2, o2, p, b, y2, h) {
        ...
        return Math.abs(j) >= f * m ? j : -function(t3, o3, f2, p2, b2, y3, h2) {
          ...
          if (K = u * h2 + n * Math.abs(J), (J += E * m2 + I * M2 - (H * j2 + G * x3)) >= K || -J >= K) return J;
  ...
  "node_modules/concaveman/index.js"(exports, module) {
    ...
    function fastConvexHull(points2) {
      ...
      for (i = 0; i < points2.length; i++) {
        if (!pointInPolygon(points2[i], cull)) filtered.push(points2[i]);
      }
...
var require_earcut = __commonJS({
  "node_modules/earcut/src/earcut.js"(exports, module) {
    ...
    function isEar(ear) {
      ...
      var p = c.next;
      while (p !== a) {
        if (p.x >= x0 && p.x <= x1 && p.y >= y0 && p.y <= y1 && pointInTriangle(ax, ay, bx, by, cx, cy, p.x, p.y) && area2(p.prev, p, p.next) >= 0) return false;
        p = p.next;
      }
      return true;
    }
    function isEarHashed(ear, minX, minY, invSize) {
      ...
      while (p && p.z >= minZ && n && n.z <= maxZ) {
        if (p.x >= x0 && p.x <= x1 && p.y >= y0 && p.y <= y1 && p !== a && p !== c && pointInTriangle(ax, ay, bx, by, cx, cy, p.x, p.y) && area2(p.prev, p, p.next) >= 0) return false;
        p = p.prevZ;
        if (n.x >= x0 && n.x <= x1 && n.y >= y0 && n.y <= y1 && n !== a && n !== c && pointInTriangle(ax, ay, bx, by, cx, cy, n.x, n.y) && area2(n.prev, n, n.next) >= 0) return false;
        n = n.nextZ;
      }
      while (p && p.z >= minZ) {
        if (p.x >= x0 && p.x <= x1 && p.y >= y0 && p.y <= y1 && p !== a && p !== c && pointInTriangle(ax, ay, bx, by, cx, cy, p.x, p.y) && area2(p.prev, p, p.next) >= 0) return false;
...
function angle(startPoint, midPoint, endPoint, options = {}) {
  ...
  let azimuthOB = bearingToAzimuth(
    options.mercator !== true ? bearing(O, B2) : rhumbBearing(O, B2)
  );
...
function isPointOnLineSegment(lineSegmentStart, lineSegmentEnd, pt, excludeBoundary, epsilon3) {
  const x2 = pt[0];
  const y2 = pt[1];
...
function testSegmentIntersect(seg1, seg2) {
  ...
  if (uA >= 0 && uA <= 1 && uB >= 0 && uB <= 1) {
    const x5 = x1 + uA * (x2 - x1);
    const y5 = y1 + uA * (y2 - y1);
    return [x5, y5];
  }
  return false;
}
...
var Triangle = class {
  constructor(a, b, c) {
    ...
    const C = c.x - a.x;
    const D = c.y - a.y;
    const E = A * (a.x + b.x) + B2 * (a.y + b.y);
    const F = C * (a.x + c.x) + D * (a.y + c.y);
    const G = 2 * (A * (c.y - b.y) - B2 * (c.x - b.x));
    let dx;
    let dy;
    this.x = (D * E - B2 * F) / G;
    this.y = (A * F - C * E) / G;
...
function topology_default(objects, quantization) {
  var bbox3 = bounds_default(objects = geometry_default(objects)), transform = quantization > 0 && bbox3 && prequantize_default(objects, bbox3, quantization), topology = dedup_default(cut_default(extract_default(objects))), coordinates = topology.coordinates, indexByArc = hashmap_default(topology.arcs.length * 1.4, hashArc, equalArc);
...
function clone2(configObject) {
  ...
  div = /* @__PURE__ */ function() {
    function multiply(x2, k, base) {
      var m, temp, xlo, xhi, carry = 0, i = x2.length, klo = k % SQRT_BASE, khi = k / SQRT_BASE | 0;
      for (x2 = x2.slice(); i--; ) {
        xlo = x2[i] % SQRT_BASE;
...
var horizontalIntersection = (pt, v, y2) => {
  ...
  return { x: pt.x.plus(v.x.div(v.y).times(y2.minus(pt.y))), y: y2 };
};
var verticalIntersection = (pt, v, x2) => {
  if (v.x.isZero()) return null;
  return { x: x2, y: pt.y.plus(v.y.div(v.x).times(x2.minus(pt.x))) };
};
var intersection = (pt1, v1, pt2, v2) => {
  ...
  const x3 = x1.plus(x2).div(2);
  const y3 = y1.plus(y2).div(2);
  return { x: x3, y: y3 };
};
...
function ellipse(center2, xSemiAxis, ySemiAxis, options) {
  ...
  for (let i = 0; i < steps; i++) {
    ...
    if (m === 0) {
      ...
      w = (-(m * x2 + c) + Math.sqrt(Math.pow(m * x2 + c, 2) - 4 * (v * m) * -(A / k))) / (2 * (v * m));
    }
    if (x2 != 0) {
...
var GreatCircle = class {
  ...
  interpolate(f) {
    ...
    const B2 = Math.sin(f * this.g) / Math.sin(this.g);
    const x2 = A * Math.cos(this.start.y) * Math.cos(this.start.x) + B2 * Math.cos(this.end.y) * Math.cos(this.end.x);
    const y2 = A * Math.cos(this.start.y) * Math.sin(this.start.x) + B2 * Math.cos(this.end.y) * Math.sin(this.end.x);
    const z = A * Math.sin(this.start.y) + B2 * Math.sin(this.end.y);
...
function rescaleIsolines(createdIsoLines, matrix, points2) {
  ...
  const scaleY = originalHeigth / matrixHeight;
  const resize = (point2) => {
    point2[0] = point2[0] * scaleX + x0;
    point2[1] = point2[1] * scaleY + y0;
  };
...
function lineArc(center2, radius, bearing1, bearing2, options = {}) {
  ...
  if (angle1 === angle2) {
    return lineString(
      circle(center2, radius, options).geometry.coordinates[0],
      properties
    );
  }
...
function intersectSegments(a, b) {
  ...
  var intersection22 = add(p, scalarMult(t, r));
...
function planepoint(point2, triangle) {
  ...
  const z = (z3 * (x2 - x1) * (y2 - y22) + z1 * (x2 - x22) * (y2 - y3) + z2 * (x2 - x3) * (y2 - y1) - z2 * (x2 - x1) * (y2 - y3) - z3 * (x2 - x22) * (y2 - y1) - z1 * (x2 - x3) * (y2 - y22)) / ((x2 - x1) * (y2 - y22) + (x2 - x22) * (y2 - y3) + (x2 - x3) * (y2 - y1) - (x2 - x1) * (y2 - y3) - (x2 - x22) * (y2 - y1) - (x2 - x3) * (y2 - y22));
  return z;
}
...
var Graph = class _Graph {
  ...
  _computeNextCCWEdges(node, label) {
    ...
    for (let i = edges2.length - 1; i >= 0; --i) {
      let de = edges2[i], sym = de.symetric, outDE, inDE;
...
function voronoi_default() {
  ...
  voronoi.x = function(_) {
    return arguments.length ? (x2 = typeof _ === "function" ? _ : constant_default2(+_), voronoi) : x2;
  };
  voronoi.y = function(_) {
    return arguments.length ? (y2 = typeof _ === "function" ? _ : constant_default2(+_), voronoi) : y2;
  };
